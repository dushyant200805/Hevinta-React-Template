...
function mission() {
    ...
    return (
        <>
            {/* <!-- our-mission --> */}
            <section className="ptb" data-aos="fade-up">
                    ...
                    <div className="row gx-2 align-items-center">
                        ...
                        <div className="col-lg-6 col-md-12 p-2">
                            <div className="about-content p-2">
                                ...
                                <Link to="about" className="prime-btn px-3 py-2 my-3 text-capitalize"><FontAwesomeIcon icon={faPlus} className="fs-7 mx-2" /> learn More</Link>
                            </div>
                        </div>
                    </div>
                </div>
