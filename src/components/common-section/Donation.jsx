   ...
   duration: 1200, // animation duration
    ...
    <section className="py-5 position-relative donation"> 
        <div className="container d-flex align-items-center justify-content-center" data-aos="fade-up"  data-aos-duration="1500">
            <div className="donation-content text-center py-5" data-aos="fade-up">
                ...
                <div className="donation-btn my-5">
                    <Link to="/contact" className="prime-btn-2 mx-2 py-2 px-3 mb-2 fs-8 rounded-0"> Donate Now </Link>
                    <Link to="/contact" className="prime-btn-2 mx-2 py-2 px-3 fs-8 rounded-0">Become A Volunteer</Link>
                </div>
            </div>
        </div> 
    </section>
